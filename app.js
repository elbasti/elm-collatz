...
/***/ function(module, exports) {
	...
	var _user$project$Main$isEven = function ($int) {
		return _elm_lang$core$Native_Utils.eq(
			A2(
				F2(
					function (x, y) {
	...
	var _user$project$Main$collatz = function (n) {
		if (_elm_lang$core$Native_Utils.eq(n, 1)) {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			if (_user$project$Main$isEven(n)) {
				var res = (n / 2) | 0;
				return _elm_lang$core$Maybe$Just(
					{ctor: '_Tuple2', _0: res, _1: res});
			} else {
				var res = (n * 3) + 1;
				return _elm_lang$core$Maybe$Just(
					{ctor: '_Tuple2', _0: res, _1: res});
	...
	var _user$project$Main$collatzSequence = function ($int) {
		return A2(_elm_community$list_extra$List_Extra$unfoldr, _user$project$Main$collatz, $int);
	};
	var _user$project$Main$update = F2(
		function (msg, model) {
			var _p0 = msg;
			if (_p0.ctor === 'Calculate') {
				var newList = _user$project$Main$collatzSequence(model.valueToChange);
				return {
					ctor: '_Tuple2',
	...
	var _user$project$Main$Model = F2(
		function (a, b) {
			return {valueToChange: a, list: b};
		});
	var _user$project$Main$Calculate = {ctor: 'Calculate'};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('inputBox')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$placeholder('Number to calculate'),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onClick(_user$project$Main$Calculate)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('outputBox')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[]),
							A2(_elm_lang$core$List$map, _user$project$Main$listItem, model.list))
						]))
				]));
	};
