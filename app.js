...
/***/ function(module, exports) {
	...
	var _user$project$Main$nextItem = function (list) {
		var tail = function () {
		...
		return _elm_lang$core$Native_Utils.eq(tail, 1) ? list : (_user$project$Main$isEven(tail) ? A2(
			_elm_lang$core$List$append,
			list,
			_user$project$Main$nextItem(
				_elm_lang$core$Native_List.fromArray(
					[(tail / 2) | 0]))) : A2(
			_elm_lang$core$List$append,
			list,
	...
	var _user$project$Main$update = F2(
		function (msg, model) {
			var _p1 = msg;
			if (_p1.ctor === 'Calculate') {
				var newList = _user$project$Main$nextItem(
					A2(
						_elm_lang$core$List$append,
						_elm_lang$core$Native_List.fromArray(
							[model.valueToChange]),
